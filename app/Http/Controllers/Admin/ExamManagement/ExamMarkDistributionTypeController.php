...
use App\Http\Requests\ExamMarkDistributionRequest;
...
class ExamMarkDistributionTypeController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(ExamMarkDistributionRequest $request)
    {
        ExamMarkDistributionType::saveData($request);
        return redirect()->route('exam_mark_distribution_type.index')->with('success','Exam Mark Distribution Type create successfully');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('exam_mark_distribution_type.index')->with('success','Exam Mark Distribution Type Update successfully');
    }
    ...
    public function destroy($slug)
    {
        ...
        $markdist->delete();
        return redirect()->route('exam_mark_distribution_type.index')->with('success','Exam Mark Distribution Type Deleted successfully');
