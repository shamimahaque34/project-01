...
class ExamGradeController extends Controller
{
    ...
    public function store(ExamGradeRequest $request)
    {
        ...
        return redirect()->route('exam_grade.index')->with('success','Exam grade create successfully');
       }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('exam_grade.index')->with('success','Exam grade Updated successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        $grade->delete();
        return redirect()->route('exam_grade.index')->with('success','Exam grade deleted successfully');
    }
}
