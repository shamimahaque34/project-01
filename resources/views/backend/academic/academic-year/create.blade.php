                                ...
                                <div>
                                    <form action="{{ isset($academicYear) ? route('academic-years.update', $academicYear->id) : route('academic-years.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-6 mb-4" id="datepicker1">
                                            ...
                                            <input type="text" data-provide="datepicker" data-date-container="#datepicker1" data-date-min-view-mode="2" data-date-format="yyyy" class="form-control" name="session_year_start" placeholder="" value="{{ $errors->any() ? old('session_year_start') : (isset($academicYear) ? $academicYear->session_year_start : '')}}">
                                            @error('session_year_start')<span class="text-danger f-s-12">{{ $errors->first('session_year_start') }}</span> @enderror
                                        </div>

                                        <div class="col-md-6 mb-4" id="datepicker2">
                                            <label  class="form-label">
                                                Session year End
                                                <i class="dripicons-question" data-bs-toggle="tooltip" data-bs-title="Set Your Session Year End" data-bs-placement="right"></i>
                                            </label>
                                            <input type="text" data-provide="datepicker" data-date-container="#datepicker2" data-date-min-view-mode="2" data-date-format="yyyy" class="form-control" name="session_year_end" placeholder="" value="{{ $errors->any() ? old('session_year_end') : (isset($academicYear) ? $academicYear->session_year_end : '')}}">
                                            @error('session_year_end')<span class="text-danger f-s-12">{{ $errors->first('session_year_end') }}</span> @enderror
                                        </div>

                                        <div class="col-md-6 mb-4" id="datepicker3">
                                            <label  class="form-label">
                                                Session Month start
                                                <i class="dripicons-question" data-bs-toggle="tooltip" data-bs-title="Set Your Session Month Start" data-bs-placement="right"></i>
                                            </label>
                                            <input type="text" data-provide="datepicker" data-date-container="#datepicker3" data-date-format="MM" data-date-min-view-mode="1" class="form-control" name="session_month_start" placeholder="" value="{{ $errors->any() ? old('session_month_start') : (isset($academicYear) ? $academicYear->session_month_start : '')}}">
                                        ...
                                        <div class="col-md-6 mb-4" id="datepicker4">
                                            ...
                                            <input type="text" data-provide="datepicker" data-date-container="#datepicker4" data-date-format="MM" data-date-min-view-mode="1" class="form-control" name="session_month_end" placeholder="" value="{{ $errors->any() ? old('session_month_end') : (isset($academicYear) ? $academicYear->session_month_end : '')}}">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <label for=""class="mt-0"> 
                                                <input type="checkbox" class="me-1" id="switch3"  data-switch="bool"  name="status" {{ $errors->any() ? (old('status')) : (isset($academicYear) && $academicYear->status == 0 ? '' : 'checked')}} >
                                        ...
                                        <div class="col-md-6">
                                            <input type="submit" class="btn btn-success mt-3" data-provide="typeahead" id="" value="{{ isset($academicYear) ? 'Update ' : 'Create ' }} Academic Year ">
                                        </div>
                                    </form>
                                </div>
                            </div>
