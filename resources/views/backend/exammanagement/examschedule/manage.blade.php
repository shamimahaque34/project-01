                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap w-100">
                            ...
                            @foreach($schedul as $exam)
                                <tr>
                                    ...
                                    <td>{{ $exam->academicYear->session_year_start}}</td>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('exam_schedule.destroy', $exam->id) }}" method="post" style="display: inline-block"  onsubmit="return confirm('Are You sure that to delete this Exam Schedule'); ">
                                            @csrf
                                            @method('delete')
