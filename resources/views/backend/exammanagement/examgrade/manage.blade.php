                            ...
                            @foreach($grade as $exam)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('exam_grade.destroy', $exam->id) }}" method="post" style="display: inline-block"  onsubmit="return confirm('Are You sure that to delete this Exam Grade'); ">
                                            @csrf
                                            @method('delete')
