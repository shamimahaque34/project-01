                    ...
                    <div class="col-md-12 mx-auto">
                        <div class="card mt-3">
                            <div class="card-header">
                                ...
                                <a href="{{ route('translation_providers.index') }}" class="btn btn-success float-end">
                                    Manage
                            ...
                            <div class="card-body">
                                <div>
                                    <form action="{{ isset($transprov) ? route('translation_providers.update', $transprov->id) : route('translation_providers.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @if(isset($transprov))
                                            @method('put')
                                        @endif
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class=" col-md-6 mb-4">
                                                ...
                                                <label for=""class="mt-0"> 
                                                    <input type="checkbox" class="me-1" id="switch3"  data-switch="bool"  name="status" {{ $errors->any() ? (old('status')) : (isset($translationProvider) && $translationProvider->status == 0 ? '' : 'checked') }} >
