        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('translation_providers.create') }}" class="btn btn-success float-end">
                        Create
                    </a>
                </div>
                <div class="card-body">
...
{{--                                            <a href="{{route('translation.show',$tranprovider->slug)}}" class=" btn btn-primary btn-sm py-0 px-1"><i class="uil-eye"></i></a>--}}
                                            <a href="{{ route('translation_providers.edit',$tranprovider->slug) }}" class="mx-1 btn btn-info btn-sm py-0 px-1"><i class="dripicons-document-edit"></i></a>
                                            <form action="{{ route('translation_providers.destroy',$tranprovider->slug) }}" method="post" style="display: inline-block"  onsubmit="return confirm('Are You Sure That To Delete This Translation Provider'); ">
                                                @csrf
                                                @method('delete')
