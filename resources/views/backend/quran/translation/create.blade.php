                    ...
                    <div class="col-md-12 mx-auto">
                        <div class="card mt-3">
                            <div class="card-header">
                                ...
                                <a href="{{ route('translations.index') }}" class="btn btn-success float-end">
                                    Manage
                                </a>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <label for=""class="mt-0"> 
                                                    <input type="checkbox" class="me-1" id="switch3"  data-switch="bool"  name="status" {{ $errors->any() ? (old('status')) : (isset($translation) && $translation->status == 0 ? '' : 'checked') }} >
